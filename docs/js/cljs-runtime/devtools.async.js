...
var o__12462__auto___15531 = (function (){var o__12462__auto___15531 = (function (){var o__12462__auto___15531 = Promise;
return (o__12462__auto___15531["resolve"]).call(o__12462__auto___15531);
})();
return (o__12462__auto___15531["then"]).call(o__12462__auto___15531,callback);
})();
(o__12462__auto___15531["catch"]).call(o__12462__auto___15531,devtools.async.rethrow_outside_promise);
...
var G__15530_15532 = Error;
var target__12467__auto___15533 = G__15530_15532;
if(cljs.core.truth_(target__12467__auto___15533)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15530_15532)].join(''),"\n","target__12467__auto__"].join('')));
}

(target__12467__auto___15533["stackTraceLimit"] = Infinity);
