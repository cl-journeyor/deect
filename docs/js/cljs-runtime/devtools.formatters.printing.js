...
var len__5726__auto___15189 = arguments.length;
var i__5727__auto___15190 = (0);
while(true){
if((i__5727__auto___15190 < len__5726__auto___15189)){
args__5732__auto__.push((arguments[i__5727__auto___15190]));

var G__15191 = (i__5727__auto___15190 + (1));
i__5727__auto___15190 = G__15191;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15157){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15158,G__15159,seq15157__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15171_SHARP_){
return (!((cljs.core.meta(p1__15171_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15174__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15175){var _e__12473__auto__ = e15175;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e15177){var _e__12473__auto__ = e15177;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15179 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15180 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15180);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15181__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15179);
}});
...
var temp__5802__auto___15198 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___15198)){
var managed_print_level_15199 = temp__5802__auto___15198;
var _STAR_print_level_STAR__orig_val__15184_15200 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15185_15201 = managed_print_level_15199;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15185_15201);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__15182_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__15182_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15184_15200);
}} else {
job_fn();
}
