...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15745 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15745(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15746 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15746(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15747 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15747(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15748 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15748(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15753 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15753(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15754 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15754(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15755 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15755(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15756 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15756(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15757 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15757(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15758 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15758(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15759 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15759(b);
}
});
