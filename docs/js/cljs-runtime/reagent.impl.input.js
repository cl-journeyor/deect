...
var G__23133 = shadow_root.activeElement;
active_element = G__23133;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__23113){
var map__23114 = p__23113;
var map__23114__$1 = cljs.core.__destructure_map(map__23114);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23114__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__23121 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__23122 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__23122);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__23121);
}}));
} else {
...
(jsprops.onChange = (function (p1__23124_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__23124_SHARP_);
}));
