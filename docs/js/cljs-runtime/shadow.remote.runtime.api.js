...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20593 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20593(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_20594 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_20594(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_20595 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_20595(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_20596 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_20596(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_20597 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_20597(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_20598 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_20598(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__20591,callback){
var map__20592 = p__20591;
var map__20592__$1 = cljs.core.__destructure_map(map__20592);
var input = map__20592__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20592__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20592__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
