...
var G__23135 = o;
reagent.impl.template.goog$module$goog$object.set(G__23135,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23154__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23154 = function (var_args){
var args = null;
...
while (G__23156__i < G__23156__a.length) {G__23156__a[G__23156__i] = arguments[G__23156__i + 0]; ++G__23156__i;}
  args = new cljs.core.IndexedSeq(G__23156__a,0,null);
} 
return G__23154__delegate.call(this,args);};
G__23154.cljs$lang$maxFixedArity = 0;
G__23154.cljs$lang$applyTo = (function (arglist__23157){
var args = cljs.core.seq(arglist__23157);
return G__23154__delegate(args);
});
G__23154.cljs$core$IFn$_invoke$arity$variadic = G__23154__delegate;
return G__23154;
})()
;
} else {
...
var G__23136 = o;
reagent.impl.template.goog$module$goog$object.set(G__23136,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__23137 = props;
var G__23137__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23137,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23137);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23137__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23138 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23138,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23138;
}
})(),id_class);
...
var temp__5804__auto___23165 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___23165)){
var d_23166 = temp__5804__auto___23165;
if((d_23166 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_23166.s}));
} else {
...
var G__23139 = (cljs.core.count(argv) - first_child);
switch (G__23139) {
case (0):
...
var vec__23140 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23140,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23140,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23140,(2),null);
...
var temp__5808__auto___23168 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23168 == null)){
} else {
var key_23169 = temp__5808__auto___23168;
(jsprops.key = key_23169);
}
...
var temp__5808__auto___23170 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23170 == null)){
} else {
var key_23171 = temp__5808__auto___23170;
(jsprops.key = key_23171);
}
...
var temp__5808__auto___23172 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23172 == null)){
} else {
var key_23173 = temp__5808__auto___23172;
(jsprops.key = key_23173);
}
...
var temp__5808__auto___23174 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23174 == null)){
} else {
var key_23175 = temp__5808__auto___23174;
(jsprops.key = key_23175);
}
...
var temp__5808__auto___23182 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23182 == null)){
} else {
var key_23183 = temp__5808__auto___23182;
(jsprops.key = key_23183);
}
...
var temp__5808__auto___23184 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23184 == null)){
} else {
var key_23185 = temp__5808__auto___23184;
(jsprops.key = key_23185);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23143_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23143_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23144 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23144,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23144,(1),null);
...
var G__23148 = tag;
var G__23148__$1 = (((G__23148 instanceof cljs.core.Keyword))?G__23148.fqn:null);
switch (G__23148__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template23150 = (function (opts,id,fn_to_element,parse_fn,meta23151){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23150.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23152,meta23151__$1){
var self__ = this;
var _23152__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23150(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23151__$1));
}));

(reagent.impl.template.t_reagent$impl$template23150.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23152){
var self__ = this;
var _23152__$1 = this;
return self__.meta23151;
}));

(reagent.impl.template.t_reagent$impl$template23150.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23150.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23150.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23150.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23150.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23150.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23151","meta23151",-938848818,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23150.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23150.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23150");

(reagent.impl.template.t_reagent$impl$template23150.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23150");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23150.
 */
reagent.impl.template.__GT_t_reagent$impl$template23150 = (function reagent$impl$template$__GT_t_reagent$impl$template23150(opts,id,fn_to_element,parse_fn,meta23151){
return (new reagent.impl.template.t_reagent$impl$template23150(opts,id,fn_to_element,parse_fn,meta23151));
});
...
return (new reagent.impl.template.t_reagent$impl$template23150(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
