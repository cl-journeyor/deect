...
var map__12618 = top_item;
var map__12618__$1 = cljs.core.__destructure_map(map__12618);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12618__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12618__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12618__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e12617){var _e = e12617;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___12636 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12636)){
var seen_errors_12637 = temp__5802__auto___12636;
if(cljs.core.truth_(seen_errors_12637.has(self))){
} else {
seen_errors_12637.add(self);

var temp__5804__auto___12638 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12638)){
var sense_12639 = temp__5804__auto___12638;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12639)].join(''));
} else {
}
}
} else {
