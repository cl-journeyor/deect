...
var len__5726__auto___14813 = arguments.length;
var i__5727__auto___14814 = (0);
while(true){
if((i__5727__auto___14814 < len__5726__auto___14813)){
args__5732__auto__.push((arguments[i__5727__auto___14814]));

var G__14815 = (i__5727__auto___14814 + (1));
i__5727__auto___14814 = G__14815;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__14771_14816 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__14772_14817 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__14773_14818 = true;
var _STAR_print_fn_STAR__temp_val__14774_14819 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__14773_14818);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__14774_14819);

try{var _STAR_print_level_STAR__orig_val__14775_14820 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14776_14821 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14776_14821);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14775_14820);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__14772_14817);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__14771_14816);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq14758){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14758));
}));
...
var new_formatters = current_formatters.filter((function (p1__14795_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__14795_SHARP_)));
}));
...
var G__14796_14822 = f;
var target__12467__auto___14823 = G__14796_14822;
if(cljs.core.truth_(target__12467__auto___14823)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14796_14822)].join(''),"\n","target__12467__auto__"].join('')));
}

(target__12467__auto___14823["toString"] = (function (){
...
var G__14797_14824 = "%c%s";
var G__14798_14825 = "color:transparent";
var G__14799_14826 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__14797_14824,G__14798_14825,G__14799_14826) : f.call(null,G__14797_14824,G__14798_14825,G__14799_14826));
...
var vec__14804 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14804,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14804,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14830__delegate = function (add_fmt,add_args){
...
var G__14830 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__14831__i = 0, G__14831__a = new Array(arguments.length -  1);
while (G__14831__i < G__14831__a.length) {G__14831__a[G__14831__i] = arguments[G__14831__i + 1]; ++G__14831__i;}
  add_args = new cljs.core.IndexedSeq(G__14831__a,0,null);
} 
return G__14830__delegate.call(this,add_fmt,add_args);};
G__14830.cljs$lang$maxFixedArity = 1;
G__14830.cljs$lang$applyTo = (function (arglist__14832){
var add_fmt = cljs.core.first(arglist__14832);
var add_args = cljs.core.rest(arglist__14832);
return G__14830__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq14800){
...
var G__14803 = cljs.core.first(seq14800__$2);
var seq14800__$3 = cljs.core.next(seq14800__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14801,G__14802,G__14803,seq14800__$3);
}));
...
var seq__14807 = cljs.core.seq(features);
var chunk__14808 = null;
var count__14809 = (0);
var i__14810 = (0);
while(true){
if((i__14810 < count__14809)){
var feature = chunk__14808.cljs$core$IIndexed$_nth$arity$2(null,i__14810);
...
var G__14833 = seq__14807;
var G__14834 = chunk__14808;
var G__14835 = count__14809;
var G__14836 = (i__14810 + (1));
seq__14807 = G__14833;
chunk__14808 = G__14834;
count__14809 = G__14835;
i__14810 = G__14836;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__14807);
if(temp__5804__auto__){
var seq__14807__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__14807__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__14807__$1);
var G__14837 = cljs.core.chunk_rest(seq__14807__$1);
var G__14838 = c__5525__auto__;
var G__14839 = cljs.core.count(c__5525__auto__);
var G__14840 = (0);
seq__14807 = G__14837;
chunk__14808 = G__14838;
count__14809 = G__14839;
i__14810 = G__14840;
continue;
} else {
var feature = cljs.core.first(seq__14807__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__14841 = cljs.core.next(seq__14807__$1);
var G__14842 = null;
var G__14843 = (0);
var G__14844 = (0);
seq__14807 = G__14841;
chunk__14808 = G__14842;
count__14809 = G__14843;
i__14810 = G__14844;
continue;
}
} else {
...
var G__14811 = feature;
var G__14811__$1 = (((G__14811 instanceof cljs.core.Keyword))?G__14811.fqn:null);
switch (G__14811__$1) {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14812 = temp__5802__auto__;
return (o14812["version"]);
} else {
return null;
}
})() == null);
