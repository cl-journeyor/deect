...
var len__5726__auto___15126 = arguments.length;
var i__5727__auto___15127 = (0);
while(true){
if((i__5727__auto___15127 < len__5726__auto___15126)){
args__5732__auto__.push((arguments[i__5727__auto___15127]));

var G__15128 = (i__5727__auto___15127 + (1));
i__5727__auto___15127 = G__15128;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq15106){
...
return cljs.core.some((function (p1__15108_SHARP_){
return (p1__15108_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__15111){
var vec__15112 = p__15111;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15112,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq15109){
var G__15110 = cljs.core.first(seq15109);
var seq15109__$1 = cljs.core.next(seq15109);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15110,seq15109__$1);
}));
...
var G__15136 = (i__5727__auto___15135 + (1));
i__5727__auto___15135 = G__15136;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__15118){
var vec__15119 = p__15118;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15119,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq15115){
var G__15116 = cljs.core.first(seq15115);
var seq15115__$1 = cljs.core.next(seq15115);
var G__15117 = cljs.core.first(seq15115__$1);
var seq15115__$2 = cljs.core.next(seq15115__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15116,G__15117,seq15115__$2);
}));
