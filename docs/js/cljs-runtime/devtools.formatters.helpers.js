...
var G__15105 = devtools.prefs.pref(v);
v = G__15105;
continue;
} else {
return v;
...
}catch (e15082){var _e__12473__auto__ = e15082;
return false;
}})();
...
}catch (e15088){var _e__12473__auto__ = e15088;
return false;
}})();
...
}catch (e15090){var _e__12473__auto__ = e15090;
return false;
}}
}
});
...
var vec__15100 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15100,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15100,(1),null);
...
return cljs.core.some((function (p1__15103_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15103_SHARP_);
}),template);
});
