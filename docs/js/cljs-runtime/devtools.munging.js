...
var o14993 = temp__5802__auto__;
var temp__5802__auto____$1 = (o14993["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o14994 = temp__5802__auto____$1;
return (o14994["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12462__auto__ = f;
return (o__12462__auto__["toString"]).call(o__12462__auto__);
} else {
return "";
}
}catch (e14995){var _ = e14995;
return "";
}});
...
try{var o__12462__auto___15073 = t;
(o__12462__auto___15073["cljs$lang$ctorPrWriter"]).call(o__12462__auto___15073,t,writer);
}catch (e14996){var __15074 = e14996;
}
...
var char_code = (function (){var o__12462__auto__ = (new String(char$));
return (o__12462__auto__["charCodeAt"]).call(o__12462__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12462__auto__ = String;
return (o__12462__auto__["fromCharCode"]).call(o__12462__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14997 = num_code;
switch (G__14997) {
case (1):
return (185);
...
var o__12462__auto__ = String;
return (o__12462__auto__["fromCharCode"]).call(o__12462__auto__,superscript_code);
});
/**
...
}catch (e14998){var _e__12473__auto__ = e14998;
return false;
}})())){
...
var vec__14999 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14999,(0),null);
...
var len__5726__auto___15076 = arguments.length;
var i__5727__auto___15077 = (0);
while(true){
if((i__5727__auto___15077 < len__5726__auto___15076)){
args__5732__auto__.push((arguments[i__5727__auto___15077]));

var G__15078 = (i__5727__auto___15077 + (1));
i__5727__auto___15077 = G__15078;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15004){
var vec__15005 = p__15004;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15005,(0),null);
...
var G__15079 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__15080 = cljs.core.butlast(remaining_tokens);
name_tokens = G__15079;
remaining_tokens = G__15080;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15002){
var G__15003 = cljs.core.first(seq15002);
var seq15002__$1 = cljs.core.next(seq15002);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15003,seq15002__$1);
}));
...
var vec__15010 = cljs.core.split_with((function (p1__15009_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15009_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15010,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15010,(1),null);
...
var vec__15016 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15016,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15016,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__15083 = cljs.core.rest(remaining_tokens);
var G__15084 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__15083;
name_tokens = G__15084;
continue;
} else {
...
var vec__15021 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15021,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15021,(1),null);
var vec__15024 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15024,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15024,(1),null);
var vec__15027 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15027,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15027,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15027,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15027,(3),null);
...
var vec__15032 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15032,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15032,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15032,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15032,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15032,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15032,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__15035 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15035,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15035,(1),null);
var vec__15038 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15038,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15038,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__15041 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__15041) : devtools.munging.parse_fn_info_deep.call(null,G__15041));
})()));
}
} else {
return fn_info;
...
var G__15092 = (arity + (1));
var G__15093 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15042){
var vec__15043 = p__15042;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15043,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15043,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15046_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__15046_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15047_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__15047_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___15094 = arguments.length;
var i__5727__auto___15095 = (0);
while(true){
if((i__5727__auto___15095 < len__5726__auto___15094)){
args__5732__auto__.push((arguments[i__5727__auto___15095]));

var G__15096 = (i__5727__auto___15095 + (1));
i__5727__auto___15095 = G__15096;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15050){
var vec__15051 = p__15050;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15051,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15048){
var G__15049 = cljs.core.first(seq15048);
var seq15048__$1 = cljs.core.next(seq15048);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15049,seq15048__$1);
}));
...
var map__15055 = options;
var map__15055__$1 = cljs.core.__destructure_map(map__15055);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15055__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15055__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15055__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15055__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15056 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15056,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15056,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15056,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15056,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15056,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15056,(5),null);
...
var o__12462__auto__ = f;
return (o__12462__auto__["getBasis"]).call(o__12462__auto__);
});
/**
...
}catch (e15059){var _e__12473__auto__ = e15059;
...
var G__15098 = (obj[cljs.core.first(path)]);
var G__15099 = cljs.core.rest(path);
obj = G__15098;
path = G__15099;
continue;
} else {
...
var _STAR_ = (function (accum,p__15060){
var vec__15061 = p__15060;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15061,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15061,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15064){
var vec__15065 = p__15064;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15065,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15065,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15065,(2),null);
...
var post_process = (function (p__15069){
var vec__15070 = p__15069;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15070,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15070,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15068_SHARP_){
return (obj[cljs.core.first(p1__15068_SHARP_)]);
}),sorted_matches);
