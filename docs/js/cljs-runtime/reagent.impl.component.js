...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23018 = c;
var G__23018__$1 = (((G__23018 == null))?null:G__23018.prototype);
if((G__23018__$1 == null)){
return null;
} else {
return G__23018__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23021 = c;
var G__23021__$1 = (((G__23021 == null))?null:G__23021.prototype);
if((G__23021__$1 == null)){
return null;
} else {
return G__23021__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__23116__delegate = function (args){
...
while (G__23117__i < G__23117__a.length) {G__23117__a[G__23117__i] = arguments[G__23117__i + 0]; ++G__23117__i;}
  args = new cljs.core.IndexedSeq(G__23117__a,0,null);
} 
return G__23116__delegate.call(this,args);};
G__23116.cljs$lang$maxFixedArity = 0;
G__23116.cljs$lang$applyTo = (function (arglist__23118){
var args = cljs.core.seq(arglist__23118);
return G__23116__delegate(args);
});
...
var or__5002__auto__ = (function (){var G__23029 = c;
var G__23029__$1 = (((G__23029 == null))?null:G__23029.constructor);
if((G__23029__$1 == null)){
return null;
} else {
return G__23029__$1.displayName;
}
})();
...
var G__23030 = c;
var G__23030__$1 = (((G__23030 == null))?null:G__23030.constructor);
if((G__23030__$1 == null)){
return null;
} else {
return G__23030__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__23031 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23032 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23032);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23031);
}});
...
var G__23036 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__23036 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23036);
}
} else {
return null;
}
...
var renders_23125 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23126 = cljs.core.first(cljs.core.vals(renders_23125));
...
if((cljs.core.count(renders_23125) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23125))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23126)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23126], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23106 = o;
reagent.impl.component.goog$module$goog$object.set(G__23106,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__23107 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23108 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23108);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23107);
}});
...
var vec__23109 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23109,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23109,(1),null);
